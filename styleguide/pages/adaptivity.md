...
Для начала, нужно обернуть ваше приложение в [`AdaptivityProvider`](https://inomdzhon.github.io/test-action-for-forked-rep/#/AdaptivityProvider).
...
Далее, нужно добавить [`SplitLayout`](https://inomdzhon.github.io/test-action-for-forked-rep/#/SplitLayout) и хотя бы один [`SplitCol`](https://inomdzhon.github.io/test-action-for-forked-rep/#/SplitCol).
